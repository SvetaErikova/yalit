							...
							try {
								for (i.s(); !(t = i.n()).done; ) {
									...
									o &&
										e.push({
											html:
												'<div class="fancybox__thumb" style="background-image:url(\''.concat(
													o,
													"')\"></div>",
												),
				...
				s(t, [
								...
								if (
									...
									(t.videoId = a),
										(t.src = "https://www.youtube-nocookie.com/embed/"
											...
											.concat(o)),
										(t.thumb =
											t.thumb || "https://i.ytimg.com/vi/".concat(a, "/mqdefault.jpg")),
										(t.vendor = "youtube"),
										(i = "video");
					...
					},
					{
						...
						value: function (t, e) {
							...
							e.slides.forEach(function (t) {
								t.$el &&
									(t.$iframe && i.resizeIframe(t), t.ratio && i.setAspectRatio(t));
							});
						},
					},
					{
									...
									if ("done" === t.state && t.$iframe && t.$iframe.contentWindow) {
										...
										if (t.$iframe.isReady)
											return (
												...
												void (
													i && t.$iframe.contentWindow.postMessage(JSON.stringify(i), "*")
												)
											);
										"youtube" === t.vendor &&
					...
					},
					{
						...
						value: function (t, e, i) {
							...
							o &&
								(o.parentNode.insertBefore(n, o), o.remove(), (n.$placeHolder = null));
						},
					},
					{
						key: "onMessage",
					...
					},
					{
						...
						value: function () {
							...
							var r,
								...
								h = x(
									this.fancybox.$container.querySelectorAll(".fancybox__button--zoom"),
								);
							try {
								for (h.s(); !(r = h.n()).done; ) {
									var d = r.value;
							...
							var u,
								f = x(
									this.fancybox.$container.querySelectorAll("[data-fancybox-index]"),
								);
							try {
								for (f.s(); !(u = f.n()).done; ) {
							...
							if (!this.fancybox.option("infinite")) {
								var g,
									m = x(
										this.fancybox.$container.querySelectorAll("[data-fancybox-prev]"),
									);
								try {
									for (m.s(); !(g = m.n()).done; ) {
										var y = g.value;
								...
								var b,
									w = x(
										this.fancybox.$container.querySelectorAll("[data-fancybox-next]"),
									);
								try {
									for (w.s(); !(b = w.n()).done; ) {
										var k = b.value;
							...
							value: function (t) {
								...
								if (
									...
									if (
										...
										var n =
											void 0 === i.hideClass ? this.option("hideClass") : i.hideClass;
										this.animateCSS(
											i.$content,
											n,
											function () {
