		...
		return "path" !== R && t.getBBox
			? ((s = (function _createPath(t, e) {
				...
				"rect" === R
					...
					: "circle" === R || "ellipse" === R
						? ((h =
								"circle" === R ? (o = i = M.r) * L : ((o = M.rx), (i = M.ry) * L)),
							(n =
								"M" +
								((r = M.cx) + o) +
								"," +
	...
	function measureSegment(t, e, n) {
		...
		for (T.length = S.length = 0, a = e + 2; a < b; a += 6) {
			if (
				...
				for (r = 1; r <= w; r++)
					(l =
						h - (h = ((m = P * r) * m * o + 3 * (d = 1 - m) * (m * i + d * s)) * m)),
		...
		if (T.length && C) {
			if (
				((t.totalLength = x = T[T.length - 1] || 0), x / (t.minLength = C) < 9999)
			)
		...
		Y =
			...
			(n.equals = function equals(t) {
				var e = this.a,
					...
					i = this.f;
				return (
					e === t.a && n === t.b && r === t.c && a === t.d && o === t.e && i === t.f
				);
			}),
