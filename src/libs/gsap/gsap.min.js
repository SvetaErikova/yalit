...
!(function (t, e) {
	...
	function Fb(t) {
		...
		if (((Dt.lastIndex = 0), Dt.test(r)))
			return (
				(e = zt.test(r)), (t[1] = Cb(t[1], e)), (t[0] = Cb(t[0], e, Bb(t[1]))), !0
			);
	}
	function Ob(t) {
		var e = (t + "").split("("),
		...
		return (
			ha(t, function (t) {
				for (var e in ((Bt[t] = ot[t] = a), (Bt[(n = t.toLowerCase())] = r), a))
					Bt[n + ("easeIn" === e ? ".in" : "easeOut" === e ? ".out" : ".inOut")] =
						Bt[t + "." + e] = a[e];
			}),
			a
		);
	...
	var qt,
		...
		Ut =
			...
			(qt.reversed = function reversed(t) {
				return arguments.length
					? (!!t !== this.reversed() && this.timeScale(-this._rts || (t ? -X : 0)),
						this)
					: this._rts < 0;
			}),
	...
	var Xt = (function (i) {
		...
		return (
			...
			(e.render = function render(t, e, r) {
				...
				if (
					(this !== I && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)
				) {
					if (
							...
							if (
								...
								if (
									...
									g ||
										...
										((g = this._pt =
											new _e(this._pt, x, dr, 0, 1, v.renderTransform, v, 0, -1)).dep =
											1)),
									"scale" === c)
								)
									(this._pt = new _e(
