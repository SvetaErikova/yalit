		...
		((Observer.prototype.init = function init(e) {
				...
				if (!pc(e, 1)) {
					...
					(se.x = t),
						...
						(i || Math.abs(se.startX - t) >= c || Math.abs(se.startY - n) >= c) &&
							(h && (ne = !0), i || (se.isDragging = !0), tc(r, o), i || (g && g(se)));
				}
			}
			function xc(e) {
				return (
			...
			function zc(e) {
				if (!pc(e)) {
					var t = ue(),
						n = de();
					sc((t - fe) * W, (n - ge) * W, 1), (fe = t), (ge = n), a && te.restart(!0);
				}
			}
			function Ac(e) {
				if (!pc(e)) {
					(e = K(e, s)), V && (oe = !0);
					var t =
						(1 === e.deltaMode ? n : 2 === e.deltaMode ? Pe.innerHeight : 1) * d;
			...
			var ee,
				...
				ge = de(),
				pe =
					~t.indexOf("touch") && !~t.indexOf("pointer") && "pointerdown" === Te[0],
				he = y(i),
