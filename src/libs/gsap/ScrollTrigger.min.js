	...
	var k =
		((Observer.prototype.init = function init(e) {
			...
			var ee,
				...
				de = fe(),
				he =
					~t.indexOf("touch") && !~t.indexOf("pointer") && "pointerdown" === Re[0],
				ge = A(o),
			...
			((ScrollTrigger.prototype.init = function init(M, O) {
				if (
					...
					var A,
						...
						ge =
							M.horizontal || (M.containerAnimation && !1 !== M.horizontal) ? Le : Ie,
						ve = !E && 0 !== E,
						be = J(M.scroller || He),
						...
						ye =
							"fixed" ===
							("pinType" in M ? M.pinType : z(be, "pinType") || (me && "fixed")),
									...
									if (e <= Y && B <= e && c !== e) {
										...
										!1 === ue.inertia && (a = l - n),
											A(
												...
												{
													duration: h(
														dt((0.185 * Math.max(dt(s - i), dt(l - i))) / o / 0.05 || 0),
													),
													ease: ue.ease || "power3",
													data: dt(c - e),
					...
					if (
							...
							if ((!Qe && Ce.enabled) || t)
								if (ae && e && ut) rb(ScrollTrigger, "scrollEnd", Jb);
									...
									var i,
										...
										T = Qa(r)
											? r.start
											: M.start || (0 !== M.start && oe ? (ae ? "0 0" : "0 100%") : 0),
									...
									for (
										we &&
										Qa(r) &&
										((g = Ne.getProperty(L, ge.p)), (v = Ne.getProperty(I, ge.p)));
										P--;
									)
									...
									if (
										...
										Ce._endClamp &&
											!ot &&
											((Ce._endClamp = Y || -0.001), (Y = Math.min(Y, La(be, ge)))),
										(N = Y - B || ((B -= 0.01) && 0.001)),
										...
										(i = hb(ae)),
											...
											!y &&
												...
												me &&
													"scroll" !== hb(Je)["overflow" + ge.a.toUpperCase()] &&
										...
										for (o = oe.parentNode; o && o !== Je; )
											o._pinOffset && ((B -= o._pinOffset), (Y -= o._pinOffset)),
												(o = o.parentNode);
									d &&
										...
										(x || Oe !== Ce.progress || pe) &&
											(O &&
												!ve &&
												O.totalProgress(
													pe && B < -0.001 && !Oe ? Ne.utils.normalize(B, Y, 0) : Oe,
													!0,
												),
						...
						(Ce.labelToScroll = function (e) {
							return (
								(O &&
									O.labels &&
									(B || Ce.refresh() || B) + (O.labels[e] / O.duration()) * N) ||
								0
							);
						}),
										...
										a && !Qe
											? (ve &&
												...
												de &&
													...
													(Ra(Ce.callbackAnimation),
													ee ? ee.progress(1) : Ra(O, "reverse" === o ? 1 : !p, 1)))
											: ve && C && !Qe && C(Ce);
								}
								if (x) {
						...
						(Ce.kill = function (e, t) {
							...
							0 <= r && Et.splice(r, 1),
								...
								O &&
									((O.scrollTrigger = null), e && O.revert({ kill: !1 }), t || O.kill()),
								q &&
									[q, F, L, I].forEach(function (e) {
	...
	function pc(e) {
		...
		if (!a._isScrollT || 2e3 < s - a._isScrollT) {
			for (
				...
				o = o.parentNode;
			(a._isScroll =
				o && o !== n && !Ha(o) && (re[(t = hb(o)).overflowY] || re[t.overflowX])),
				(a._isScrollT = s);
		}
