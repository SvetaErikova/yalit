		...
		ge =
			...
			(t.equals = function equals(e) {
				var t = this.a,
					...
					a = this.f;
				return (
					t === e.a && n === e.b && o === e.c && r === e.d && i === e.e && a === e.f
				);
			}),
					...
					(r &&
						...
						(r && !e) ||
							...
							(v = Math.max(0, i.scrollWidth - i.clientWidth)) &&
								(v +=
									parseFloat(t.paddingLeft) + (O ? parseFloat(t.paddingRight) : 0))),
			...
			return (
				...
				Z(a)
					? function (e) {
							...
							return (
								a.call(q, (s < e ? s + (e - s) * t : e < l ? l + (e - l) * t : e) * n) *
								n
							);
						}
					: ke(a)
				...
				p.liveSnap &&
					...
					W
						...
						: n.points
							...
							: (V &&
									(C = Ah(o ? n : n.x || n.left || n.scrollLeft, S, E, f ? -1 : 1)),
					...
					W
						? ((a = Math.atan2(L.y - t, e - L.x) * Ae),
							180 < (l = q.y - a)
								...
								: l < -180 && ((D += 360), (q.y = a)),
							(i =
								q.x !== T || Math.abs(D - a) > j ? ((q.y = a), T + (D - a) * c) : T))
						: (A &&
