...
!(function (e, t) {
			...
			if (s.loop) {
				const s = t.getSlideIndex(
					...
					a = t.getSlideIndex(
						t.slides.filter(
							(e) =>
								1 * e.getAttribute("data-swiper-slide-index") == t.slides.length - 1,
						)[0],
					),
					i = t.slidesGrid[s],
					r = t.slidesGrid[a],
	...
	function de(e, t, s) {
		...
		return (
			r ||
				((r = g("div", "swiper-slide-shadow" + (s ? `-${s}` : ""))), i.append(r)),
			r
		);
	}
					...
					(() => {
						...
						if (e) {
							...
							for (let a = 0, i = t.slides.length; a < i; a += 1) {
								const i = t.slides[a];
								if (
									(i.getAttribute("data-hash") || i.getAttribute("data-history")) === e
								) {
