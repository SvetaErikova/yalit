...
import {Card, Card_accommodation, Card_doc, Card_offers, Card_reviews, Special_card} from './card.jsx';
...
export const All_cards_special = () => {
  return (
    <>
      <Special_card title='Свидание в купели: романтика в Японском саду'
                    img='/../../assets/img/special_card_img.svg'
                    cascadeContent={<><p>Тёплая термальная вода, лепестки цветов, японский сад и вечерний свет создают пространство для отдыха и близости.</p>
                      <p>Спецпредложение идеально подойдёт для романтического вечера, особого события или спокойного отдыха вдвоём.</p></>}/>
      <Special_card title='Свидание в купели: романтика в Японском саду'
                    img='/../../assets/img/special_card_img.svg'
                    cascadeContent={<><p>Тёплая термальная вода, лепестки цветов, японский сад и вечерний свет создают пространство для отдыха и близости.</p>
                      <p>Спецпредложение идеально подойдёт для романтического вечера, особого события или спокойного отдыха вдвоём.</p></>}/>
